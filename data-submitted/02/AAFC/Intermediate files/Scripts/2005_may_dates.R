...
d<-data.frame(shift=1:length(stimes),start.dt=as.POSIXct('129 2005 10:00',format='%j %Y %H:%M')+(c(0,ct[-length(ct)]))*3600,end.dt=as.POSIXct('129 2005 10:00',format='%j %Y %H:%M')+(ct)*3600)
