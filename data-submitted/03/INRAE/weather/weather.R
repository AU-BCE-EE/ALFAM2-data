...
wfile <- 'ALFAM2_template_7.0_META_METHA_Vf.xlsx'
efile <- 'ALFAM2_template_7.0_META_METHA_Vf_v3.xlsx'
...
# Weather
wthr <- read_xlsx(wfile, sheet = 12, skip = 4, col_names = nms, na = na.strings)
