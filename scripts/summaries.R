...
ds <- ds[, c('inst', 'eid', 'pid', 'pmid', 
             ...
             'air.temp.6', 'air.temp.12', 'air.temp.24', 'air.temp.48', 'air.temp.mn', 
             'air.temp.z', 
             'soil.temp.6', 'soil.temp.12', 'soil.temp.24', 'soil.temp.48', 'soil.temp.mn', 
             'soil.temp.z', 
             'rad.6', 'rad.12', 'rad.24', 'rad.48', 'rad.mn', 
             'wind.6', 'wind.12', 'wind.24', 'wind.48', 'wind.mn', 
             'wind.z', 
             'wind.2m.6', 'wind.2m.12', 'wind.2m.24', 'wind.2m.48', 'wind.2m.mn', 
             'wind.loc', 
             'rain.1', 'rain.6', 'rain.12', 'rain.24', 'rain.48', 'rain.tot', 
             'rain.rate.1', 'rain.rate.6', 'rain.rate.12', 'rain.rate.24', 'rain.rate.48', 'rain.rate.mn', 
             'rh.6', 'rh.12', 'rh.24', 'rh.48', 'rh.mn', 
             'far.loc', 
...
sink('../logs/ALFAM_summary_record.txt', append = TRUE)
  ...
  cat('and ', length(ds), ' rows\n')
  cat('and ', nrow(ds), ' columns.\n')
sink()
