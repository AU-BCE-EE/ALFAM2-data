...
ggplot(d, aes(ct, e.rel, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'none') + facet_wrap(~ first.rows) + labs(x = 'Elapsed time (h)', y = 'NH3 emission (frac. app. TAN)')
ggplot(d, aes(ct, e.rel, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'top') + labs(x = 'Elapsed time (h)', y = 'NH3 emission (frac. app. TAN)')

if (!(all(is.na(d$cta)))) {
  ggplot(d, aes(cta, e.rel, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'top') + labs(x = 'Elapsed time (after application) (h)', y = 'NH3 emission (frac. app. TAN)')
}

if (!(all(is.na(d$t.end)))) {
  ggplot(d, aes(t.end, e.rel, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'none') + labs(x = 'Date/time', y = 'NH3 emission (frac. app. TAN)')
  ggplot(d, aes(t.end, e.rel, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'none') + facet_wrap(~ first.rows) + labs(x = 'Date/time', y = 'NH3 emission (frac. app. TAN)')
}
```
...
```{r, echo = FALSE}
ggplot(d, aes(ct, j.NH3, colour = first.rows)) + geom_step() + geom_point() + theme(legend.position = 'none') + facet_wrap(~ first.rows) + labs(x = 'Elapsed time (h)', y = 'NH3 flux (kg N/ha-h)')
ggplot(d, aes(ct, j.NH3, colour = first.rows)) + geom_step() + geom_point() + theme(legend.position = 'top') + labs(x = 'Elapsed time (h)', y = 'NH3 flux (kg N/ha-h)') 
if (!(all(is.na(d$cta)))) {
  ggplot(d, aes(cta, j.NH3, colour = first.rows)) + geom_step() + geom_point() + theme(legend.position = 'top') + labs(x = 'Elapsed time (from application) (h)', y = 'NH3 flux (kg N/ha-h)')
}
```
...
```{r, echo=FALSE}
ggplot(d, aes(ct, wind, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'top') + labs(x = 'Elapsed time (h)', y = 'Wind (m/s')
ggplot(d, aes(ct, air.temp, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'none') + labs(x = 'Elapsed time (h)', y = 'Air temp. (deg. C)')
ggplot(d, aes(ct, rain.rate, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'none') + labs(x = 'Elapsed time (h)', y = 'Rain (mm/h)')
ggplot(d, aes(ct, rain.cum, colour = first.rows)) + geom_line() + geom_point() + theme(legend.position = 'none') + labs(x = 'Elapsed time (h)', y = 'Rain (mm)')
```
