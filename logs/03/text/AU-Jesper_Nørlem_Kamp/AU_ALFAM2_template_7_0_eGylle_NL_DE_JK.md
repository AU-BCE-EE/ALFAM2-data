...
## Minimum                   AU    eGylle   eGylle2 FoulumgårdD         1
## Maximum                   AU    eGylle   eGylle3         WUR         1
## Mean                    <NA>      <NA>      <NA>        <NA>      <NA>
## Unique (excld. NA)         1         1         2           2         1
## Missing values             0         0         0           0         0
## Sorted                  TRUE      TRUE      TRUE        TRUE      TRUE
##                                                                       
##                          rep           app.start sub.period
## Class              character     POSIXct, POSIXt    numeric
## Minimum                    1 2021-08-20 10:58:00          3
## Maximum                    1 2021-11-09 10:15:00          3
## Mean                    <NA> 2021-10-11 12:13:12          3
...
## Minimum            eGylle_bLS_acid_traps_0.25m       bLS    Acid traps    <NA>
## Maximum                             eGylle_IHF       IHF     CRDS avg.    <NA>
## Mean                                      <NA>      <NA>          <NA>    <NA>
## Unique (excld. NA)                          14         4             3       0
## Missing values                               0         0             3      14
...
## Minimum                 <NA>       778      52    5.65        DK      Flat
## Maximum                 <NA>      1540    56.5    9.56        NL      Flat
## Mean                    <NA>      1270    53.6    7.04      <NA>      <NA>
## Unique (excld. NA)         0         2       2       2         2         1
## Missing values            14         0       0       0         0         0
...
## Mean                  13.5      24      65     3.5      <NA>       <NA>
## Unique (excld. NA)       2       1       1       1         0          2
## Missing values           0       9       9       5        14          0
...
## Minimum                 4.95      <NA>       2.8    1.73    <NA>    <NA>
## Maximum                 6.78      <NA>      3.48    1.95    <NA>    <NA>
## Mean                    <NA>      <NA>      <NA>    1.81    <NA>    <NA>
## Unique (excld. NA)         2         0         2       2       0       0
## Missing values             0        14         0       0      14      14
## Sorted                  TRUE      <NA>      TRUE   FALSE    <NA>    <NA>
##                                                                         
##                    man.vfa    man.ph             app.end app.method app.rate
## Class              numeric character     POSIXct, POSIXt  character  numeric
## Minimum                0.3       7.7 2021-08-20 10:58:00       bsth     17.5
## Maximum                0.3       7.9 2021-11-09 10:20:00         os     35.9
## Mean                   0.3      <NA> 2021-10-11 12:16:25       <NA>     24.1
## Unique (excld. NA)       1         2                   2          2        2
## Missing values           9         0                   0          0        0
## Sorted                TRUE     FALSE                TRUE       TRUE    FALSE
##                                                                             
##                    app.rate.unit    incorp time.incorp man.area dist.inj
## Class                  character character     numeric  numeric  numeric
## Minimum                     t/ha      none        <NA>     26.6     <NA>
## Maximum                     t/ha      none        <NA>     39.8     <NA>
## Mean                        <NA>      <NA>        <NA>     31.3     <NA>
## Unique (excld. NA)             1         1           0        2        0
## Missing values                 0         0          14        0       14
...
## Mean                   <NA>     <NA>      <NA>    7.39      <NA>    <NA>
## Unique (excld. NA)        0        0         2       2         0       0
## Missing values           14       14         0       0        14      14
## Sorted                 <NA>     <NA>     FALSE    TRUE      <NA>    <NA>
##                                                                         
...
## Maximum                     .                6      <NA> 20/08/2021 10:58
## Mean                     <NA>             5.64      <NA>             <NA>
## Unique (excld. NA)          1                2         0                2
## Missing values              5                0        14                0
## Sorted                   TRUE             TRUE      <NA>            FALSE
##                                                                          
##                        app.end.orig
## Class                     character
## Minimum            09/11/2021 10:20
## Maximum            20/08/2021 10:58
## Mean                           <NA>
## Unique (excld. NA)                2
## Missing values                    0
## Sorted                        FALSE
...
## Maximum            D:1.I:AU.Pr:eGylle.E:eGylle3           Jesper Nørlem Kamp
## Mean                                       <NA>      <NA>               <NA>
...
## Minimum               30.2  0.0941   0.488   0.752    1.25    1.62    1.94
## Maximum                 70   0.209    2.15    3.02    18.5    20.6    23.2
## Mean                  44.4   0.126     1.1    1.57    4.37    5.62     6.9
## Unique (excld. NA)       2       4      12      12      14      14      14
## Missing values           0      10       2       2       0       0       0
## Sorted               FALSE   FALSE   FALSE   FALSE   FALSE   FALSE   FALSE
##                                                                           
##                       e.72    e.96   e.168 e.final   e.tot e.cum.1 e.cum.4
## Class              numeric numeric numeric numeric numeric numeric numeric
## Minimum               2.42    2.42    10.4    2.42    2.42  0.0941   0.488
## Maximum               24.8    25.5    26.5    26.7    26.7   0.209    2.15
## Mean                   7.8    8.37    16.8    8.97    8.97   0.126     1.1
## Unique (excld. NA)      14      14       5      14      14       4      12
## Missing values           0       0       9       0       0      10       2
## Sorted               FALSE   FALSE   FALSE   FALSE   FALSE   FALSE   FALSE
##                                                                           
##                    e.cum.6 e.cum.12 e.cum.24 e.cum.48 e.cum.72 e.cum.96
## Class              numeric  numeric  numeric  numeric  numeric  numeric
## Minimum              0.752     1.25     1.62     1.94     2.42     2.42
## Maximum               3.02     18.5     20.6     23.2     24.8     25.5
## Mean                  1.57     4.37     5.62      6.9      7.8     8.37
## Unique (excld. NA)      12       14       14       14       14       14
...
## Class                numeric     numeric   numeric numeric numeric numeric
## Minimum                 10.4        2.42      2.42 0.00311  0.0161  0.0249
## Maximum                 26.5        26.7      26.7 0.00693  0.0376  0.0517
## Mean                    16.8        8.97      8.97 0.00418   0.027  0.0385
## Unique (excld. NA)         5          14        14       4      12      12
## Missing values             9           0         0      10       2       2
## Sorted                 FALSE       FALSE     FALSE   FALSE   FALSE   FALSE
##                                                                           
##                    e.rel.12 e.rel.24 e.rel.48 e.rel.72 e.rel.96 e.rel.168
## Class               numeric  numeric  numeric  numeric  numeric   numeric
## Minimum              0.0415   0.0537   0.0641   0.0801   0.0801     0.149
## Maximum               0.264    0.294    0.331    0.355    0.365     0.379
## Mean                 0.0812    0.108    0.135    0.156     0.17      0.24
## Unique (excld. NA)       14       14       14       14       14         5
## Missing values            0        0        0        0        0         9
## Sorted                FALSE    FALSE    FALSE    FALSE    FALSE     FALSE
##                                                                          
##                    e.rel.final e.rel.tot  rain.1  rain.4  rain.6 rain.12
## Class                  numeric   numeric numeric numeric numeric numeric
## Minimum                 0.0801    0.0801       0       0       0       0
## Maximum                  0.382     0.382       0       0       0       0
## Mean                     0.184     0.184       0       0       0       0
## Unique (excld. NA)          14        14       1       1       1       1
## Missing values               0         0      10       2       2       0
...
## Mean                     <NA>       11.8         12        13.2        10.2
## Unique (excld. NA)          0          2          4           5           5
## Missing values             14          6          6           4           4
...
## Mean                      10.3        10.5        10.7         11.1        13.8
## Unique (excld. NA)           6           6           6            6           6
...
## Maximum                          <NA>              <NA>    <NA>    2.73       3
## Mean                             <NA>              <NA>    <NA>    2.72    2.82
## Unique (excld. NA)                  0                 0       0       2       4
## Missing values                     14                14      14       6       6
## Sorted                           <NA>              <NA>    <NA>   FALSE   FALSE
##                                                                                
##                    wind.12 wind.24 wind.48 wind.72 wind.96 wind.168 wind.mn
## Class              numeric numeric numeric numeric numeric  numeric numeric
## Minimum                2.5    1.54    1.31    1.35    1.23     1.78    1.78
## Maximum               3.18    1.88    1.42    1.42    1.42     2.11    3.32
## Mean                  2.83    1.69    1.36    1.39    1.33     1.94    2.51
## Unique (excld. NA)       5       5       6       6       6        6       6
...
## Missing values          14      14      14      14      14      14      14
...
## Missing values          14      14      14          10           2           2
...
## Class              numeric numeric numeric numeric numeric numeric numeric
## Minimum              0.983 0.00309  0.0933   0.983    18.2   0.983    96.6
## Maximum                7.1  0.0356    2.49     7.1    25.9     7.1     238
## Mean                  2.22 0.00977   0.543    2.15    23.6    2.22     162
## Unique (excld. NA)       6      14      14       6       5       6       6
...
## Maximum            2021-11-09 10:20:00 2021-11-15 08:47:00          2
## Mean               2021-10-11 12:24:51 2021-10-17 09:00:21          2
## Unique (excld. NA)                   6                   7          1
...
## Missing values              14      14        14      14        14         14
